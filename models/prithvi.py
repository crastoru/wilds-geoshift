...
class TemporalEncoder(nn.Module):
    ...
    def forward(self, temporal_coords: torch.Tensor, tokens_per_frame = None):
        """
...
class PrithviViT(nn.Module):
    ...
    def forward(
        ...
        cls_tokens = cls_token.expand(x.shape[0], -1, -1).to(x.device)
...
class PrithviMAE(nn.Module):
    ...
    def unpatchify(self, patchified_pixel_values, image_size = None):
        """
        Args:
